    ...
    chatCommandHandler: async (interaction) => {
        ...
        if (!username) {
            await interaction.reply({
                content: "You haven't linked your GitHub account yet. Please link your account first.",
            });
            return;
        }
        ...
        try {
            ...
            const userInfoRes = await fetch(`https://api.github.com/users/${username}`);
            ...
            if (userInfo && userRepos) {
                ...
                const embed = {
                    ...
                    fields: [
                        ...
                        { name: "Public Repositories", value: `${publicReposCount}`, inline: true },
                        { name: "Repositories", value: `${reposCount}`, inline: true },
